...
var file_movie_movie_proto_rawDesc = []byte{
	...
	0x6f, 0x76, 0x69, 0x65, 0x73, 0x32, 0x9b, 0x01, 0x0a, 0x0b, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x6d,
	...
	0x73, 0x22, 0x00, 0x42, 0x44, 0x5a, 0x42, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_movie_movie_proto_depIdxs = []int32{
	...
	1, // 4: movie.Moviemanger.GetMovie:output_type -> movie.Movie
	2, // 5: movie.Moviemanger.GetMovies:output_type -> movie.Movies
	2, // 6: movie.Moviemanger.GetRecommendations:output_type -> movie.Movies
